...
public class RegistrarConsumo extends JDialog implements ActionListener{
    ...
    public RegistrarConsumo(InterfazClub pPrincipal, ArrayList pClientes )
    {
    ...
    public void actionPerformed( ActionEvent pEvento )
    {
        ...
        if( REGISTRAR_CONSUMO.equals( actionCommand ) )
        {
            ...
            else
            {
                ...
                {
                    JOptionPane.showMessageDialog( this, "El valor a registrar debe ser un valor num�rico.", "Registrar consumo", JOptionPane.ERROR_MESSAGE );
                }
            }
        }
    }
