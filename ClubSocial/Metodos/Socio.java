...
public class Socio
{
    ...
    public void aumentarFondos( double pFondos ) throws Exception
    {
        ...
        {
            throw new Exception( "Con este monto se excederan los fondos maximos de un socio VIP, ingrese una cantidad menor" );
        }
        else if( tipoSubscripcion == Tipo.REGULAR && pFondos + fondos > MONTO_MAXIMO_REGULARES )
        {
            throw new Exception( "Con este monto se excederan los fondos maximos de un socio regular, ingrese una cantidad menor" );
        }
        else
        {
