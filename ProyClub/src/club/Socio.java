...
public class Socio
{
     ...
     *
     */
    public void aumentarFondos( double pFondos)throws Exception{//exceptiontion
     ...
     *
     */
    public void registrarConsumo(String pNombre, String pConcepto, double pValor) throws Exception {//excepcion
        if( pValor > fondos ){
     ...
     *
     */
    public void agregarAutorizado( String pNombreAutorizado ) throws Exception {//excepcion
     ...
     *
     */
    public void eliminarAutorizado(String pNombreAutorizado) throws Exception//excepcion
    {
        boolean encontro = false;
     ...
     *
     */
    public void pagarFactura( int pIndiceFactura) throws Exception//excepcion
    {
